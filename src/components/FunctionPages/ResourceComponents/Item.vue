    ...
    <el-container direction="vertical">
        <el-card>
            <div slot="header" class="clearfix">
                <span style="font-weight: bolder">术语词典</span>
                <el-container style="float: right">
                    <el-button style="padding: 5px 3px" type="primary" v-on:click="addFormVisible=true"><span style="font-weight: bolder">添加术语</span></el-button>
        ...
        <el-dialog title="添加术语" :visible.sync="addFormVisible">
    ...
    export default {
        ...
        methods: {
            ...
            pageList() {
                ...
                this.$axios.get("/getusermemory/0/0/99999").then(res=>{
                    if (res.data.return_code==="SUCCESS"){
